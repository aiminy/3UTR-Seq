...
#' out.file.pattern= "DoGs_adjust_by_batch"
#'
#'
#' Re.unadjusted.adjusted<-ProcessOutputFilesFrom5Cases(dir.name,input.file.pattern,out.dir.name,out.file.pattern,adjust_by_batch="YES")
#'

ProcessOutputFilesFrom5Cases<-function(dir.name,input.file.pattern,out.dir.name,out.file.pattern,adjust_by_batch){
  ...
  write.csv(re.DESeq.DoGs.plus.minus.gene.interested,file=paste0(out.dir.name,"3UTR_DE_",out.file.pattern,".csv"))
